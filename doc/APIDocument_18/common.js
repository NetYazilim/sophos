...
*/
var Language = {
  "IPsecNoNat": "Not translated",
  "IPsecLocalSubnet": "Translated subnet",
  "IPsecOriginalSubnet": "Original subnet",
  "IPsecOriginalSubnetHelp": "Select the subnet that's common to the local and remote sites.",
  "EnableSecureConnection": "Secure log transmission",
  ...
  "QuotaHTTP": "Quota HTTP",
  /*context: On Policy page, when the user clicked on the HTTP policy action, this displayed as label for Quota*/
  "QuotaHTTPMessage": "Using quota for HTTP.",
  /*context: On Policy page, hoovering mouse above HTTP action, this is displayed*/
  "QuotaHTTPS": "Quota HTTPS",
  /*context: On Policy page, when the user clicked on the HTTPS policy action, this displayed as label for Quota*/
  "QuotaHTTPSMessage": "Using quota for HTTPS.",
  /*context: On Policy page, hoovering mouse above HTTPS action, this is displayed*/
  "QuotaBlocked": "Blocked (quota available)",
  /* context: Policy test page, Result field for quota action */
  "Apps": "Apps",
  "BytesIn": "Bytes in",
  "BytesOut": "Bytes out",
  ...
  "CertValidation": "HTTPS certificate validation",
  ...
  "PressEnterForMoveRule": "Select the Enter key.",
  ...
  "MalwareScanMode": "Web proxy scanning mode",
  "MalwareScanModeDesc": "Real-time mode improves performance by allowing parts of a file to be downloaded before the scan is complete. DPI engine always uses real-time mode.",
  ...
  "WebQuotas": "Quotas",
  /*context:" Protect -> Web -> Protection / Quotas block title"*/
  "QuotaLimit": "Allowed time quota",
  /*context:"Protect -> Web -> Protection / Configuration value for the Quota Time limit."*/
  "WebQuotaDescription": "Set the maximum allowed time for a single user to browse web content that falls into categories restricted by a quota policy action.",
  /*context:"Protect -> Web -> Protection / Configuration value for the Quota Time limit."*/
  "LegacyWarning": "This option can be enforced by the web proxy only.",
  "UpstreamProxyLegacyWarning": "To use a parent proxy for web browsing, web proxy must be enabled in the firewall rule.",
  "PolicyLegacyWarning": "This policy includes options that can be enforced by the web proxy only.",
  /****************************
   * End of topic
   *****************************/
  ...
  /****************************
   * Protect -> Web -> Policy Quota Status
   *****************************/
  "WebQuotas": "Policy Quota Status",
  /*context:"Menu item of the Policy Quota Status page"*/
  "QuotaTableColumnUser": "User",
  /*context:"Policy Quota table, User column header name(name of the user which is affected by the given quota)"*/
  "QuotaTableColumnPolicy": "Policy",
  /*context:"Policy Quota table, Policy column header name(name of the policy which contains the affected by the given quota)"*/
  "QuotaTableColumnTimeLeft": "Time remaining",
  /*context:"Policy Quota table, Time remaining column header name(leftover time in minutes for the given user in the given quota)"*/
  "QuotaTableMinute": "minute",
  /*context:"Policy Quota table, Time remaining column,for displaying remaining time in a row"*/
  "QuotaTableMinutes": "minutes",
  /*context:"Policy Quota table, Time remaining column,for displaying remaining time in a row"*/
  "QuotaTableResetButtonText": "Reset",
  /*context:"Policy Quota table, Reset button above the table"*/
  "QuotaTableResetMessage": "Are you sure you want to reset the selected Web Policy Quotas?",
  /*context:"Policy Quota table, confirmation for resetting quota items."*/
  /****************************
   * End of topic
   *****************************/
  ...
  "EditOnTheMainWindow": ". Edit on the main page.",
  "FilterFilrewallRule": "Filter firewall rule",
  "FilterNATRule": "Filter NAT rule",
  "Editapplicationconfigurationforweb": "Edit application configuration in the web policy",
  "Editapplicationconfigurationforapp": "Edit application configuration in the application filter policy",
  "EditUserConfiguration": "Edit user configuration",
  "Blocksrcipwithlocalaclexceptionrule": "Block source IP address with local ACL exception rule",
  "CreateObjCustomWebsiteCategory": "Create objectionable custom website category",
  "CreateAccptCustomWebsiteCategory": "Create acceptable custom website category",
  "CreateObjCustomURLCategory": "Create objectionable custom URL category",
  "CreateAccptCustomURLCategory": "Create acceptable custom URL category",
  "CreateCustomCategory": "Create custom category",
  "CreateCustomWebsiteCategory": "Create custom website category",
  "CreateCustomURLCategory": "Create custom URL category",
  "CreateURLGroup": "Create URL group",
  "EditIPSPOLICY": "Edit IPS policy",
  "DisableThisSIDintothesameIPSPolicy": "Disable the signature for this IPS policy",
  "EditWebFilterPolicy": "Edit web policy",
  "EditAppFilterPolicy": "Edit application filter policy",
  "addlogvalueto": "Add log value to:",
  ...
  "PolicyRoutingAddTitle": "Add SD-WAN policy route",
  "PolicyRoutingUpdateTitle": "Edit SD-WAN policy route",
  "AboutThisPolicyRoute": "About this SD-WAN policy route",
  ...
  "MTUValue": "MTU value must be between 576 and 9000",
  "MSSValue": "MSS value must be between 536 and 8960",
  /* context: "MSS = Maximum Segment Size (TCP)" */
  "MTUMSSValue": "MTU value must be at least 40 bytes greater than MSS value",
  "STP": "Turn on Spanning Tree Protocol (STP)",
  "STPMaxage": "STP max age (seconds)",
  "STPMaxageRange": "(6-40)",
  "STPMaxageValue": "Max age value must be from 6 to 40",
  "MACAging" : "MAC aging (seconds)",
  "MACAgingRange": "(0-65535)",
  "MACAgingValue": "MAC aging timer must be from 0 to 65535.",
  ...
  "AdvanceSetting": "Advanced security settings",
  "InspectUntrusted": "Inspect untrusted content",
  "InspectAll": "Inspect all content",
  "InspectUntrustedDetail": "For optimal performance, inspect only untrusted content.",
  "InspectAllDetail": "For maximum security, inspect trusted and untrusted content.",
  "BannerSetting": "Outbound banner settings",
  "MemberInterfaces": "Member interfaces",
  "EnableRouting": "Enable routing on this bridge pair",
  "ARPBroadcast": "Permit ARP broadcast",
  ...
  "not_null_msg": "Enter a value for ",
  ...
  "Save": "Apply",
  "Test": "Test",
  "TestFirewallPolicy": "Firewall, SSL/TLS, and web",
  "TestWebPolicy": "Web policy only",
  ...
  "NoCASBRecordsFound": "<p class='app-text is-text-bold is-text-first-row'>No records found</p><p class='app-text'>For cloud traffic reporting, use the following firewall and SSL/TLS rule settings:</p><ul class='app-text'><li>Basic: Turn on <span class='app-text is-text-bold'>Log firewall traffic</span> for visiblity and bytes transferred.</li><li>Detailed: Turn on SSL/TLS decryption and select a web policy other than \"None\".</li></ul>",
  ...
  "UnauthUserNeedsAuth": "Unauthenticated user is browsing and needs to be authenticated",
  "IfADSSOConfigured": "If Active Directory (AD) SSO is configured",
  "ADSSOMechanism": "AD SSO mechanism",
  "NTLMOnly": "NTLM only",
  "KerberosNTLM": "Kerberos & NTLM",
  "ADSSOFailsCaptivePortal": "Note: If AD SSO fails, show captive portal",
  "IfADSSOUnconfigured": "If AD SSO isn't configured",
  "UnauthReachesBlockPage": "When unauthenticated user reaches a block page",
  "DisplayCaptivePortalLink": "Display captive portal link",
  "CaptivePortalBehavior": "Captive portal behavior",
  "DisplayUserPortalLink": "Display user portal link",
  "DisplayWebpageAfterLogin": "Display web page after login",
  "OpenWebpage": "Open web page",
  "OpenWebpageNewWindow": "In new browser window",
  "OpenWebpageCaptivePortalWindow": "In captive portal window",
  "Webpage": "Web page",
  "WebpageOriginallyRequested": "Originally requested by user",
  "WebpageCustom": "Custom",
  "LogOutUser": "Log out user when",
  "LogOutUserPortalClosed": "Captive portal page is closed or redirected",
  "LogOutUserInactive": "User is inactive",
  "LogOutUserNever": "Never",
  "UserLoggedOutImmediately": "User will be logged out immediately as captive portal window is closed on redirect.",
  "TrafficFlowRequired": "Traffic flow required to consider the user active",
  "TrafficFlowRequiredBytes": "Bytes in",
  "TrafficFlowRequiredMinutes": "Minutes",
  "CustomURLIPRequired": "Custom URL/IP address is required.",
  "CustomURLIPInvalid": "Custom URL/IP address is invalid.",
  "MinutesFieldRequired": "Minutes is required.",
  "MinutesFieldInvalid": "Minutes must be between 3 and 1440.",
  "BytesFieldRequired": "Bytes is required.",
  "BytesFieldInvalid": "Bytes must be greater than 0.",
  "UseInsecureHTTP": "Use insecure HTTP instead of HTTPS",
  "CaptivePortalAppearance": "Captive portal appearance",
  "PageLayout": "Layout",
  "PageLayoutDefault": "Default layout",
  "PageLayoutCustom": "Custom HTML",
  "LogoDefault": "Default",
  "LogoCustom": "Custom",
  "LogoImage": "Logo image",
  "LogoLink": "Logo link",
  "LogoLinkInvalid": "Logo link is invalid.",
  "LoginPageHeader": "Login page header HTML",
  "UserPrompt": "User prompt",
  "UserPromptRequired": "User prompt is required.",
  "UsernameFieldLabel": "Username field label",
  "UsernameFieldLabelRequired": "Username field label is required.",
  "PasswordFieldLabel": "Password field label",
  "PasswordFieldLabelRequired": "Password field label is required.",
  "LoginButtonLabel": "Login button label",
  "LoginButtonLabelRequired": "Login button label is required.",
  "LogoutButtonLabel": "Logout button label",
  "LogoutButtonLabelRequired": "Logout button label is required.",
  "UserPortalLinkLabel": "User portal link label",
  "UserPortalLinkLabelRequired": "User portal link label is required.",
  "RegistrationLinkLabel": "Registration link label",
  "LoginPageFooter": "Login page footer HTML",
  "BackgroundColor": "Background color",
  "BackgroundFontColor": "Header and footer font color ",
  "HeaderBackColor": "Custom logo background color",
  "UserPromptFontColor": "User prompt font color",
  "UserPortalLinkFontColor": "User portal link font color",
  "LogoutLoginSame": "Login and logout button labels must be different",
  "CustomImgMsg": "Please select a custom logo file",
  "WebPolicyActionsUnauth": "Web policy actions for unauthenticated users",
  "WebPolicyActionsMoved": "Can now be configured from Authentication > Web authentication, along with other AD SSO related settings.", // NC-40494
  ...
  "SpamQuarantineDigestSettings": "Quarantine settings",
  "ChangeBtn": "Change user's quarantine digest settings",
  "EnableOption": "Enable quarantine digest",
  "SpamDigestConfMsg": "Are you sure you want to configure the quarantine settings?",
  ...
  "File_Name": "File name",
  "Context": "Context",
  "SSL_TLS_Rule_ID": "SSL/TLS rule",
  "SSL_TLS_Rule_Name": "SSL/TLS rule name",
  "decryptionProfileName": "Decryption profile",
  "profileID": "Profile ID",
  "cipherSuite": "Cipher suite",
  "SSLTLSPolicy": "SSL/TLS policy",
  "tlsVersion": "TLS version",
  "certFingerprint": "Certificate fingerprint",
  "resumedSession": "Resumed session",
  "rejectAndNotify": "Reject and notify",
  "doNotDecrypt": "Do not decrypt",
  "SSLTLS": "SSL/TLS",
  "Quota": "Quota",
  ...
  "Apply_Web_Category_based_QoS_Policy": "Apply web category-based traffic shaping",
  "AV": "AV",
  ...
  "Max1024ValAllowed": "You can add a maximum of 1024 {value}",
  "gatewayNotSame": "You cannot use the same gateway for \"Primary gateway\" and \"Backup gateway\".",
  ...
  "enableConfirm": "Turn on these firewall rules?",
  "disableConfirm": "Turn off these firewall rules?",
  "disableSuccessMessage": "Turned off firewall rules.",
  "disableFailedMessage": "Couldn't turn off firewall rules.",
  "grpDisabledChkBoxMsg": "Cannot select group when filter is applied. You can expand and select rules.",
  ...
  "HighAvailabilityDetails": "High availability configuration",
  "HAConfigMode": "HA configuration mode",
  "HAAdminUser": "HA administration user name",
  "PeerHALinkIP": "Dedicated peer HA link IPv4 address",
  "PeerAdminPort": "Peer administration port",
  "PeerAdminIP": "Peer administration IPv4 address",
  ...
  "BtnPrimaryChange": "Switch to passive device",
  "BtnAuxChange": "Switch to active device",
  "PrimaryChangeConfirmMsg": "This device will be restarted. <br/>Switch the device to passive?",
  "AuxChangeConfirmMsg": "Peer device will restart. <br/>Switch it to active?",
  ...
  "UnboundInterfaceConfirmWarning": "Unbinding an interface may break or delete dependent configurations, such as device access, interface-based hosts, VLANs, gateways, static routes.<br/>For details, go to <a onclick=\"openHelp()\">Interfaces</a>.<br/><br/>Unbind the interface?",
  "LAGUpdConfMsgWarning": "Updating LAG details may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots. For details, select <a onclick=\"openHelp()\">LAG</a>.<br/><br/>Update LAG details?",
  ...
  "NoteUpdConfMsgWarning1": "Updating an interface may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots.",
  "NoteUpdConfMsgWarning3": " <br/><br/>Update the interface details?",
  "VLANUpdConfMsgWarning1": "Updating the VLAN details may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots.",
  "VLANUpdConfMsgWarning3": "<br/><br/>Update the VLAN interface details?",
  "InterfaceDeleteConfirmWarning1": "Deleting an interface may break or delete dependent configurations, for example, device access, interface-based hosts, gateways, static routes.",
  "InterfaceDeleteConfirmWarning3": "<br/><br/>Delete the interfaces?",
  "AliasDeleteConfirmWarning1": "Deleting an alias may break or delete dependent configurations, for example, device access, interface-based hosts, gateways, static routes.",
  "AliasDeleteConfirmWarning3": "<br/><br/>Delete the alias?",
  "UnboundInterfaceConfirmWarning1": "Unbinding an interface may break or delete dependent configurations, for example, device access, interface-based hosts, gateways, static routes.",
  "UnboundInterfaceConfirmWarning3": "<br/><br/>Unbind the interface?",
  "LAGUpdConfMsgWarning1": "Updating the LAG details may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots.",
  "LAGUpdConfMsgWarning3": "<br/><br/>Update the LAG details?",
  "AddBridgePairConfirmMessageWarning1": "Adding an interface to the bridge pair may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots.",
  "AddBridgePairConfirmMessageWarning3": "<br/><br/>Add an interface to the bridge pair?",
  "UpdateBridgePairConfirmMessageWarning1": "Updating the bridge pair details may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots.",
  "UpdateBridgePairConfirmMessageWarning3": "<br/><br/>Update the bridge pair details?",
  "AddLocalWiFiBridgePairWarning1": "Adding an interface to the bridge pair may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots.",
  "AddLocalWiFiBridgePairWarning3": "<br/>If a DHCP server wasn't created on the selected interface, it will be created automatically on the bridge.<br/> Note: Applies only to <b>Bridge to LAN</b> SSIDs.<br/><br/>Add an interface to the bridge pair?",
  "UpdateLocalWiFiBridgePairWarning1": "Updating the bridge pair details may interrupt its dependent configurations, for example, device access, interface-based hosts, gateways, static routes, DHCP servers, hotspots.",
  "UpdateLocalWiFiBridgePairWarning3": "<br/>If a DHCP server wasn't created on the selected interface, it will be created automatically on the bridge.<br/>Note: Applies only to <b>Bridge to LAN</b> SSIDs.<br/><br/>Update the bridge pair details?",
  ...
  "GatewayDeleteConfirmWarning": "Deleting a gateway may interrupt its dependent configurations, for example, SD-WAN policy routes, firewall rules.<br/><br/>Delete the selected gateways?",
  ...
  "NetworkUpdateTitle": "Edit network",
  ...
  /* context: "connection type" */
  "RouteBased": "Tunnel interface",
  "useRouteBased": "Consider using tunnel interface",
  /* context: "connection type" */
  ...
  "subnetCreateHelp": "You must first create these subnets in \"Hosts and services\".",
  ...
  "WebProxy": "Web proxy",
  "UseProxyAndDecrypt": "Use proxy and decrypt for ports 80 and 443",
  "UseProxyAndNoDecrypt": "Use proxy for ports 80 and 443",
  "UseProxy": "Use proxy",
  "FilterCommonWebPorts": "Filtering common web ports",
  "WebProxyOptions": "Web proxy options",
  "UseDPIEngine": "Use DPI engine",
  "ProxyNotUsed": "Proxy not used",
  ...
  "EmailNoticeMgmtIntf": "Management interface IP address",
  "EmailNoticeMgmtIntfNote": "Sent in email notifications",
  ...
  "BridgePairContainChar": "Hardware name must begin with an alphabet and can contain only alphanumeric characters and \"_\"",
  ...
  "VLANIDMSG": "Enter a VLAN ID from 1 to 4094.",
  "VLANRange": "(1—4094)",
  "invalidVlanIdMsg": "Invalid value. Enter a number or range (example: 20—35).",
  "vlanIdDupMsg": "VLAN ID exists. Enter a different one.",
  "vlanIdMaxLimit": "You can enter a maximum of 100 VLAN IDs.",
  ...
  "UserportalConfMsg": "Update authentication settings of user portal?",
  "UserportalAuth": "User portal authentication methods",
  ...
  "CustomTopImage": "Top image",
  "TopImage": "Top image",
  "CustomBottomImage": "Bottom image",
  ...
  "validRadiusTimeout": "Timeout should be between 1-60 seconds",
  ...
  "ResetDataConfirm": "Reset the rule's data transfer count?",
  "ResetDataCounterLable": "Reset data transfer count",
  ...
  "HotspotNewPolicyMsg": "A new firewall rule with linked NAT rule will be created corresponding to the hotspot",
  "DHGrp1": "1 (DH768)",
  "DHGrp2": "2 (DH1024)",
  "DHGrp5": "5 (DH1536)",
  "DHGrp14": "14 (DH2048)",
  ...
  "NTLMSettings": "AD SSO settings (NTLM and Kerberos)",
  ...
  "NTLMConfirmMessage": "Are you sure you want to update AD SSO settings?",
  ...
  "SpamDigestSettings": "Quarantine settings",
  ...
  "WAFPolicyDomainInvalid": "Invalid domain name \"{domainName}\". Use only \"a\"-\"z\", \"0\"-\"9\", \".\", \"-\", \"_\" characters. You can prefix \"*.\" for fallback hosts.",
  ...
  "NTLMClient": "AD SSO NTLM",
  "KRBClient": "AD SSO Kerberos",
  ...
  "Mon": "MM",
  "DD": "DD",
  "NTLMEnable": "AD SSO authentication is enabled. Modifying the \"Selected authentication server\" list may affect AD SSO authentication",
  "AllowedDomain": "Referred domains",
  "YouMustEnterMinimum": "You must enter minimum ",
  "characterFor": " character for ",
  ...
  "VLANBridgeMember": "VLAN (Bridge member)",
  ...
  "LAGContainChar": "Hardware name must begin with an alphabet and can contain only alphanumeric characters and \"_\"",
  ...
  "IPv4Policy": "IPv4 SD-WAN policy route",
  "IPv6Policy": "IPv6 SD-WAN policy route",
  "invalid_address": {
  ...
  "MTURangeForIPv6": "(1280-9000)",
  "MTUValueForIPv6": "MTU value must be between 1280 and 9000",
  ...
  "DHCPRelayMaxIPExceed": "Maximum \"{number}\" servers can be configured",
  ...
  "OverrideNATforInterface": "Override source translation for specific outbound interfaces",
  ...
  "AcceptHotFixes": "Allow automatic installation of hotfixes",
  ...
  "Request": "Request",
  "Response": "Response",
  "PeerAdminIPv6": "Peer administration IPv6 address",
  ...
  "PolicyRouting": "SD-WAN policy routing",
  "Routing": "Routing",
  ...
  "ProtectedServers": "Protected servers",
  ...
  "ParanoiaLevel": "Filter strength",
  "ParanoiaLevel_1": "Level 1 (most permissive)",
  "ParanoiaLevel_2": "Level 2",
  "ParanoiaLevel_3": "Level 3",
  "ParanoiaLevel_4": "Level 4 (most restrictive)",
  ...
  "SSLConnections": "SSL/TLS connections",
  "DecryptionCapacity": "Decryption capacity",
  "Capacity": "Capacity",
  "Decrypted": "Decrypted",
  "FirewallSessions": "Firewall sessions",
  "ActiveConnectionsPerTime": "Average active connections per {time}",
  "OfTraffic": "Of traffic",
  "DecryptSessions": "Decrypt sessions",
  "Now": "Now",

  "DecryptionProfile": "Decryption profile",
  "DecryptionProfiles": "Decryption profiles",
  "AddDecryptionProfile": "Add decryption profile",
  "EditDecryptionProfile": "Edit decryption profile",
  "CloneDecryptionProfile": "Clone decryption profile",
  "CAs": "CAs",
  "InvalidCertificates": "Invalid certificates",
  "Algorithms": "Algorithms",
  "InvalidDate": "Invalid date",
  "InvalidForOtherReasons": "Invalid for other reasons",
  "UntrustedIssuer": "Untrusted issuer",
  "NameMismatch": "Name mismatch",
  "Revoked": "Revoked",
  "RejectWithNotify": "Reject & notify",
  "ResigningCertificateAuthority": "Re-signing certificate authority",
  "UseCAsDefinedInSettings": "Use CAs defined in SSL/TLS settings",
  "RSAResigning": "Re-sign RSA with",
  "ECResigning": "Re-sign EC with",
  "UndecryptableTraffic": "Non-decryptable traffic",
  "UnrecognizedCipherSuites": "Unrecognized cipher suites",
  "SSLConnectionsExceeded": "When SSL/TLS connections exceed limit",
  "SSLConnectionsExceededDescription": "Applies to excess traffic when volume exceeds decryption capability.",
  "OldSSL": "SSL 2.0 and SSL 3.0",
  "SSLCompression": "SSL compression",
  "CertificateProtocolCipherEnforcement": "Certificate, protocol, and cipher enforcement",
  "CertificateErrorsToBlock": "Certificate errors to block",
  "MinimumRSAKeySize": "Minimum RSA key size",
  "MinimumSSLVersion": "Minimum SSL/TLS version",
  "MaximumSSLVersion": "Maximum SSL/TLS version",
  "MaximumSSLSupported": "Maximum supported",
  "BlockCipherAlgorithms": "Cipher algorithms to block",
  "BlockAction": "Block action",
  "NameFieldRequired": "Name is required.",
  "NoMinimum": "No minimum",
  "AllowWithoutDecryption": "Allow without decryption",
  "DropWithoutDecryption": "Drop without decryption",
  "RejectWithoutDecryption": "Reject without decryption",
  "UseSystemDefault": "Use SSL/TLS settings default",
  "KeyExchange": "Key exchange",
  "BlockCiphers": "Bulk ciphers",
  "HashAlgorithms": "Hash algorithms",
  "InvalidMinSSLVersion": "Minimum SSL/TLS version is invalid.",
  "InvalidMaxSSLVersion": "Maximum SSL/TLS version is invalid.",
  "InvalidSSLVersion": "Maximum TLS version must be later than the minimum version.",
  "EnforcementOptions": "Enforcement options",
  "NameFieldInvalid": "Name is invalid.",

  "MissingCertChain": "No certificates installed to validate this certificate's trust chain.",
  "MissingCertChainDefault": "No certificates installed to validate this certificate's trust chain. HTTPS scanning will use the default certificate \"SecurityAppliance_SSL_CA\".",
  "CertExpired": "Certificate expired or not yet valid.",
  "CertExpiredDefault": "Certificate expired or not yet valid. HTTPS scanning will use the default certificate \"SecurityAppliance_SSL_CA\".",
  "FatalCert": "Can't select this certificate for use as signing certificate.",
  "FatalCertDefault": "Can't select this certificate for use as signing certificate. HTTPS scanning will use the default certificate \"SecurityAppliance_SSL_CA\".",
  "InvalidCertConfirmation": "Save with invalid certificate selection?",
  "InvalidProfileWarning": "Profile uses a certificate that is currently not valid.",
  "InvalidProfileConfirmation": "Decryption profile uses a certificate that is currently not valid. You can save this rule, but SSL/TLS inspection will use the default certificate \"SecurityAppliance_SSL_CA\" until the profile certificate becomes valid.",
  "ControlCenterInvalidCert": "The following certificates, configured for SSL/TLS decryption, have expired, aren’t yet valid, have an incomplete trust chain, or aren’t valid for other reasons: {vrinvalidCerts}",
  "InvalidDefaultCerts": "CAs defined in SSL/TLS settings are currently not valid.",
  "SSLTLSInspectionOffWarning": "SSL/TLS inspection is disabled. After troubleshooting, {vrtlsturnonlink}.",
  "TurnItBackOn": "re-enable it",

  "enableConfirmTLSRule": "Turn on SSL/TLS inspection rule?",
  "disableConfirmTLSRule": "Turn off SSL/TLS inspection rule?",
  "moveConfirmTLSRule": "Move SSL/TLS inspection rule?",
  "CannotCloneEmptyWhitelistRule": "You cannot clone an empty exclusion rule.",
  "LogConnections": "Log connections",
  "TLSInspectionRules": "SSL/TLS inspection rules",
  "TLSInspectionRule": "SSL/TLS inspection rule",
  "AddTLSInspectionRule": "Add SSL/TLS inspection rule",
  "EditTLSInspectionRule": "Edit SSL/TLS inspection rule",
  "DecryptAction": "Action",
  "DecryptionProfileRequired": "Decryption profile is not selected",
  "UsersGroups": "User or groups",
  "TLSRuleAnybodyTooltip": "Matches any connection",
  "ApplicationWebsites": "Applications and websites",
  "Websites": "Websites",
  "CategoryWebsites": "Categories and websites",
  "UDPPropertyNotEnforced": "Any UDP property of a service will not be enforced",
  "WebsitesDefinedSNI": "Websites must be defined by SNI",
  "SyncSecurityNotSelected": "Synchronized security is not selected",
  "CategoryWebsitesNotSelected": "Category / websites is not selected",
  "DoNotDecrypt": "Do not decrypt",
  "IfTLSUsed": "(<b>{action}</b> if connection uses SSL/TLS)",
  "NotDecrypted": "Not decrypted",
  "AddSyncSecApps": "Add Synchronized Security applications",
  "EditSyncSecFilter": "Edit Synchronized Security filter",
  "Filters": "Filters",
  "SyncSecUnregisteredNotEnforced": "Synchronized Security is not enabled and therefore selections are not enforced",
  "WebUnlicensedNotEnforced": "You can configure web categories, but can't enforce them without valid web protection subscription. URL groups will work without web protection subscription.",

  "TlsSettings": "SSL/TLS inspection settings",
  "EditTlsSettings": "Edit SSL/TLS inspection settings",
  "ResigningCertificateAuthorities": "Re-signing certificate authorities",
  "OverridenByDecryptionProfiles": "These default options can be overridden by individual decryption profiles.",
  "TLS13Compatibility": "TLS 1.3 compatibility",
  "AffectsDecryptedTLS13Traffic": "This option affects all decrypted TLS 1.3 traffic.",
  "TLS13Decryption": "TLS 1.3 decryption",
  "DecryptAs13": "Decrypt as 1.3",
  "DowngradeTLS12Decrypt": "Downgrade to TLS 1.2 and decrypt",
  "IfTLS13NotCompatible": "Some server or client implementations of TLS 1.3 are not fully compatible. Select ‘Downgrade’ if you experience issues using TLS 1.3.",
  "DisableWhenTroubleShooting": "Disable only when troubleshooting",
  "OldSSLNotSupportedInspection": "SSL 2.0 and SSL 3.0 are insecure and are not supported by SSL/TLS inspection.",
  "SSLCompressionNotSupportedInspection": "SSL compression is insecure and is not supported by SSL/TLS inspection.",
  "OriginalCertRSAResign": "Used when the original website certificate was signed with an RSA certificate. Can be EC or RSA.",
  "OriginalCertECResign": "Used when the original website certificate was signed with an EC certificate. Can be EC or RSA.",

  "SSLTLSInspection": "SSL/TLS inspection",
  "SSLTLSSessions": "SSL/TLS sessions during the past 24 hours",
  "OtherTraffic": "Other traffic",
  "DecryptedSSL": "Decrypted SSL/TLS",
  "UndecryptedSSL": "Undecrypted SSL/TLS",
  "DecryptionLimit": "Decryption limit ({number})",
  "DecryptionPeak": "Decryption peak ({number})",
  "DecryptionLimitTitle": "The largest number of sessions that can be decrypted at once",
  "DecryptionPeakTitle": "The largest recorded number of sessions decrypted at once",
  "NoData": "No data available",
  "OtherTrafficDesc": "Traffic that is not SSL/TLS",
  "DecryptedSSLDesc": "Sessions selected for decryption and inspection by SSL/TLS policy",
  "UndecryptedSSLDesc": "Sessions excluded from decryption by SSL/TLS policy",

  "SSLErrors": "Errors in the past 7 days",
  "TopApplications": "Top applications",
  "TopUsers": "Top users",
  "Errors": "Errors",
  "FixErrors": "Fix errors",
  "AffectedUsers": "Affected users",
  "SSLTLSErrors": "SSL/TLS errors in the past 7 days",
  "ShowHidden": "Show hidden",
  "HideFromAppList": "Hide from application error list",
  "HideFromUserList": "Hide from user error list",
  "UnhideFromAppList": "Unhide from application error list",
  "UnhideFromUserList": "Unhide from user error list",
  "AddToWhitelist": "Exclude from decryption",
  "Exclude": "Exclude",
  "AppWhitelisted": "This application has already been excluded from decryption.",
  "DomainWhitelisted": "This domain has already been excluded from decryption.",
  "OnlySyncAppsExcludable": "You can exclude only applications detected by Synchronized Security.",
  "HiddenWhitelisted": "Can't unhide. This item has been excluded from decryption.",
  "ExcludeDecryption": "Exclude from SSL/TLS decryption",
  "SyncSecApp": "Synchronized Security application",
  "PropertyExcluded": "This property has already been excluded from decryption",
  "ExcludeOtherProperty": "Other properties (for example, user, IP address)",
  "AddToURLGroup": "Add {key} \"{value}\" to the URL group \"{group}\"",
  "AddToTLSRule": "Add {key} \"{value}\" to the SSL/TLS rule \"{rule}\"",
  "ExcludeOthersDesc": "To exclude connections based on other criteria, edit an existing SSL/TLS rule or create a new one",
  "DisableAppQuestion": "Add this application to SSL/TLS rule \"{rule_name}\"?",
  "DisableDomainQuestion": "Add this domain to URL group \"{group_name}\"?",
  "DisableSNIQuestion": "Exclude this subdomain or the entire domain? Click the button to add it to the URL group \"{group_name}\"?",
  "WhitelistTLSRuleSuccess": "Updated local SSL/TLS inspection rule \"{object_name}\".",
  "WhitelistURLGroupSuccess": "Updated URL group \"{object_name}\".",
  "DisabledTLSWhitelistRuleWarning": "Updated local SSL/TLS inspection rule \"{object_name}\", but it's currently turned off. Turn it on for the update to take effect.",
  "DisabledWebsiteWhitelistRuleWarning": "Updated URL group \"{object_name}\", but SSL/TLS inspection rule \"{rule_name}\" is currently turned off. Turn it on for the update to take effect.",
  "AddDomain": "Add domain",
  "AddSubdomain": "Add subdomain",
  "ErrorType": "Error types",
  "AffectedUsersIP": "Affected users and IP addresses",
  "AffectedApps": "Affected applications and websites",
  "ViewErrorLogsFor": "View error logs for:\n{filter1}\n{filter2}",
  "ViewErrorLogsForMessageId": "View error logs for:\n{filter1}\nMessage id {filter2}",
  "ViewAndFixErrorsFor": "View and fix errors for:\n{filter}",
  "WebcatDoesNotExist": " The web category \"{category}\" no longer exists",

  // Errors for messageids 19006 - 19013
  "InternalError": "Internal error (19006)",
  "ServerCertFailure": "Server certification validation failure (19007)",
  "ClientCertUsed": "Client certificate used (19008)",
  "UnsupportedProtocolOptions": "Unsupported protocol options (19009)",
  "DisallowedProtocolOptions": "Protocol options disallowed by decryption profile (19011)",
  "DisallowedKeyStrength": "Key strength disallowed by decryption profile (19012)",
  "DisallowedSSLVersion": "SSL/TLS version disallowed by decryption profile (19013)",
  "DisallowedConnection": "Connection disallowed by decryption profile (19014)",
  ...
  "WAFAction" : "Protect with web server protection",
  "LinkedToNatRule":"Linked to NAT rule",
  "addLinkedNatRule":"Create linked NAT rule",
  "addLinkedNatInfo":"Linked NAT will have this Firewall Rule as a NAT matching criteria. You can specify the translated source in a linked NAT rule.",
  "ScanFTP": "Scan FTP",
  "ScanFTPMalware": "Scan FTP for malware",
  "ScanHTTPProtocol": "Scan HTTP",
  "ScanHTTPS": "Decrypt & scan HTTPS",
  "VirusScan": "Scan HTTP and decrypted HTTPS",
  "UseProxyMode": "Use web proxy instead of DPI engine",
  "QuotedUseProxyMode": "\"Use web proxy instead of DPI engine\"",
  "UseProxyModeFilter": "Use web proxy",
  "DecryptSSL": "Decrypt HTTPS during web proxy filtering",
  "DecryptSSLFilter": "Decrypt HTTPS with web proxy",
  "SSLxLink": "DPI engine or web proxy?",
  "SSLxSynchronizedSecurity": "Synchronized Security applications",
  "SSLxPopupHeader": "Web filtering and SSL/TLS inspection: The options",
  "SSLxPopupNewMethod": "XG Firewall features a new DPI engine to transparently filter web traffic and inspect encrypted traffic. It offers the best performance for web filter, content scanning, and SSL/TLS inspection. It's turned on by default.",
  "SSLxPopupInspectionRule": "The web proxy is still available as an alternative and is required for some web policy options, including SafeSearch enforcement, YouTube restricted mode enforcement, and domain restrictions for Google apps.",
  "WebTrafficFilter": "Web traffic filtering",
  "SSLTLSDecryption": "SSL/TLS decryption",
  "DirectProxyMode": "Direct proxy mode",
  "SSLxPopupTableDPIWebTraffic": "DPI engine detects and filters HTTP and SSL/TLS traffic on any port.",
  "SSLxPopupTableProxyWebTraffic1": "Web proxy transparently handles traffic only on TCP ports 80 and 443.",
  "SSLxPopupTableProxyWebTraffic2": "DPI engine detects and filters HTTP and SSL/TLS traffic on other ports.",
  "SSLxPopupTableDPIDecryption1": "DPI engine applies SSL/TLS inspection rules for policy-driven decryption.",
  "SSLxPopupTableDPIDecryption2": "Visit <b>Rules and policies > SSL/TLS inspection rules</b> to manage decryption policy.",
  "SSLxPopupTableProxyDecryption1": "Web proxy optionally decrypts traffic on TCP ports 80 and 443.",
  "SSLxPopupTableProxyDecryption2": "DPI engine applies SSL/TLS inspection rules for traffic on other ports.",
  "SSLxPopupTableDirectProxyMode": "You can continue to use web proxy in direct mode by configuring the browsers on client devices.",
  ...
  "EditNewPolicy": "Edit firewall rule",
  "CloneNetworkPolicy": "Clone firewall rule",
  ...
  "SandstormDashboardRecent": "Recent",
  "SandstormDashboardRecentTooltip": "New threat reports for scanned malicious, PUA, and suspicious files in the last 7 days.",
  "SandstormDashboardIncidents": "Incidents",
  "SandstormDashboardIncidentsTooltip": "Total number of emails/downloads scanned since {start_timestamp} that were found to be malicious, PUA, or suspicious.",
  "SandstormDashboardScanned": "Scanned",
  "SandstormDashboardScannedTooltip": "Total number of emails and downloads scanned since {start_timestamp}. Enable Sandstorm in more rules and policies for best protection.",
  "SandstormStatusClean": "Clean",
  "SandstormStatusLikelyClean": "Likely clean",
  "SandstormStatusLikelyCleanTopicCase": "Likely Clean",
  "SandstormStatusSuspicious": "Suspicious",
  "SandstormStatusPua": "PUA",
  "SandstormStatusPotentiallyUnwanted": "Potentially Unwanted",
  "SandstormStatusMalicious": "Malicious",
  "SandstormStatusIncidents": "Incidents",
  "SandstormStatusInProgress": "In progress",
  "SandstormStatusNotRun": "Not Run",
  "SandstormStatusNoDetections": "No detections",
  "SandstormStatusNotDetected": "Not detected",
  "SandstormStatusError": "Error",
  "SandstormStatusFileExtractionFailure": "File extraction from archive failed",
  "SandstormStatusFileUnsupportedFailure": "File type is not supported",
  "SandstormStatusUnsuccessfulAnalysisFailure": "Unsuccessful analysis",
  "SandstormStatusPermissionDenyFailure": "Permission denied",
  "SandstormStatusRateLimiteExceedFailure": "Rate limit exceeded",
  "SandstormStatusFileDecodingFailure": "File decoding failed",
  "SandstormStatusCommunicationFailure": "Communication Failure",
  "SandstormStaticOverall": 'Static overall',
  "SandstormMLOverall": 'ML overall',
  "SandstormReputation": 'Reputation',
  "SandstormGeneticAnalysis": 'Genetic analysis',
  "SandstormMalwareScan": 'Malware scan',
  "SandstormFileAttributes": 'File attributes',
  "SandstormStartTrial": "Start 30-day trial",
  "SandstormSubscribe": "Subscribe now",
  "SandstormSuspiciousBehavior": "suspicious behavior",
  "SandstormSuspiciousBehaviors": "suspicious behaviors",
  "SandstormMalwareIdentification": "malware identification",
  "SandstormMalwareIdentifications": "malware identifications",
  "ThreatIntelligence": "Threat intelligence",
  "InvestigationAndActions": "Investigation and actions",
  "Verdict": "Verdict",
  "SandstormSummaryOverallVerdict": "Overall verdict",
  "SandstormSummaryMalwareScanResult": "Malware scan result",
  "SandstormSummaryThreatInelligenceResult": "Threat intelligence result",
  "SandstormSummaryBasedOn": "Based on:",
  "SandstormSummaryReasonIncompatibleFile": "Incompatible file",
  "SandstormReportWindowTitle": "Intelligence report",
  "SandstormActivityRetentionMsg": "Reports are retained for up to {number} months. To change the retention period, go to Reports settings > Data management.",
  "SandstormReportBytes": "Bytes",
  "SandstormReportWhen": "When",
  "SandstormReportSourceDetail": "Source details",
  "SandstormReportUserLowerCase": "user",
  "SandstormReportUsersLowerCase": "users",
  "SandstormReportTimeLowerCase": "time",
  "SandstormReportTimesLowerCase": "times",
  "SandstormReportBytes": "Bytes",
  "SandstormReportByLowerCase": "by",
  "SandstormReportAnalysisSummary": "Analysis summary",
  "SandstormReportSuspciousActivities": "suspicious activities",
  "SandstormReportSuspciousActivity": "suspicious activity",
  "SandstormReportMalwareDetections": "malware detections",
  "SandstormReportMalwareDetection": "malware detection",
  "SandstormReportIndicatorsOfCompromise": "Indicators of compromise",
  "SandstormReportMaliciousDetections": "Malicious detections",
  "SandstormReportMaliciousDetectionsTitleCase": "Malicious Detections",
  "SandstormReportSophosAv":"Sophos AV",
  "SandstormReportSophosAvPua":"Sophos AV (PUA)",
  "SandstormReportMlEngine":"ML engine",
  "SandstormReportYaraMatch":"Yara match",
  "SandstormReportInfoTitle": "Information about your file",
  "SandstormReportInfoFileName": "File name",
  "SandstormReportInfoFileType": "File type",
  "SandstormReportInfoSha1": "SHA1",
  "SandstormReportInfoSha256": "SHA256",
  "SandstormReportInfoFileSize": "File size",
  "SandstormReportInfoAllDetails": "All details",
  "SandstormReportMachineLearning": "Machine learning",
  "SandstormReportFileReputation": "File reputation",
  "SandstormReportOverallAnalysis": "Overall analysis",
  "SandstormReportFileFeatures": "File features",
  "SandstormReportFileFeature": "File feature",
  "SandstormReportBadFiles": "Bad files",
  "SandstormReportGoodFiles": "Good files",
  "SandstormReportMoreLikelyBad": "More likely in bad files",
  "SandstormReportMoreLikelyGood": "More likely in good files",
  "SandstormReportProbability": "Probability",
  "SandstormReportFileStructure": "File structure",
  "SandstormReportXgMalwareScan": "XG malware scan",
  "SandstormReportVirusTotal": "VirusTotal detections",
  "SandstormReportAnalysisDiscovered": "Analysis discovered",
  "SandstormReportSubmittedAt": "Submitted at",
  "SandstormReportDetonatedAt": "Detonated at",
  "SandstormReportAnalysisDuration": "Analysis duration",
  "SandstormReportFileExecutedAs": "File executed as",
  "SandstormReportProcesses": "Processes",
  "SandstormReportFileActivity": "File activity",
  "SandstormReportDnsRequests": "DNS requests",
  "SandstormReportHttpFlows": "HTTP flows",
  "SandstormReportKeysAdded": "Keys added",
  "SandstormReportKeysDeleted": "Keys deleted",
  "SandstormReportNetworkActivity": "Network activity",
  "SandstormReportRegistryActivity": "Registry activity",
  "SandstormReportMaliciousActivity": "Malicious activity",
  "SandstormReportScreenshots": "Screenshots",
  "SandstormReportFoundIn": "Found in",
  "SandstormReportClassificationType": "Classification type",
  "SandstormReportProcess": "Process",
  "SandstormReportParentProcess": "Parent process",
  "SandstormReportCommandLine": "Command line",
  "SandstormReportFilePath": "File path",
  "SandstormReportIpAddress": "IP address",
  "SandstormReportResponseStatus": "Response status",
  "SandstormReportResponseMIMEtype": "Response MIMEtype",
  "SandstormReportData": "Data",
  "SandstormReportSigner": "Signature trust chain",
  "SandstormReportFileSection": "File sections",
  "SandstormReportFileAnalysis": "File analysis",
  "SandstormReportFileAnalysisSummary": "File analysis summary",
  "SandstormReportResources": "Resources",
  "SandstormReportImports": "Imports",
  "SandstormReportExports": "Exports",
  "SandstormReportImagesize":  "Image size",
  "SandstormReportImagebase":  "Image base",
  "SandstormReportTimedate": "File time stamp",
  "SandstormReportMachineid": "Machine type",
  "SandstormReportSubsystem": "Subsystem",
  "SandstormReportLanguages": "Languages",
  "SandstormReportNumberofsections": "Sections",
  "SandstormReportDebugInformation": "Debug information",
  "SandstormReportPeflags": "PE flags",
  "SandstormReportOriginalfilename": "Original file name",
  "SandstormReportInternalname": "Internal name",
  "SandstormReportTiledescription": "File description",
  "SandstormReportFileversion": "File version",
  "SandstormReportPrivatebuild": "Private build",
  "SandstormReportSpecialbuild": "Special build",
  "SandstormReportComments": "Comments",
  "SandstormReportProductname": "Product name",
  "SandstormReportProductversion": "Product version",
  "SandstormReportCompanyname": "Company name",
  "SandstormReportLegalcopyright": "Copyright",
  "SandstormReportLegaltrademarks": "Trademarks",
  "SandstormReportTitle": "Document title",
  "SandstormReportAuthor": "Author",
  "SandstormReportCompany": "Author's company",
  "SandstormReportManager": "Author's manager",
  "SandstormReportCreatingApplication": "Creating application",
  "SandstormReportCreateTime": "Created",
  "SandstormReportLastSavedTime": "Last saved",
  "SandstormReportLastPrinted": "Last printed",
  "SandstormReportPrimaryLanguage": "Primary Language",
  "SandstormReportTotalEditTime": "Total edit time",
  "SandstormReportCodepage": "Code page",
  "SandstormReportVersion": "Document version",
  "SandstormReportreVisionNumber": "Document revision",
  "SandstormReportSignDate": "Signing date",
  "SandstormReportCn": "Common name",
  "SandstormReportIssuer": "Issuer",
  "SandstormReportValidity": "Validity",
  "SandstormReportUsage": "Usage",
  "SandstormReportAlgorithm": "Algorithm",
  "SandstormReportCertdepth": "Depth",
  "SandstormReportDetails": "Details",
  "SandstormReportName": "Section name",
  "SandstormReportPhysicaladdress": "Physical address",
  "SandstormReportSizeofrawdata": "Raw data (bytes)",
  "SandstormReportVirtualaddress": "Virtual address",
  "SandstormReportVirtualsize": "Virtual size (bytes)",
  "SandstormReportEntropy": "Entropy",
  "SandstormReportCharacteristics": "Characteristics",
  "SandstormReportType": "Resource type",
  "SandstormReportSize": "Bytes",
  "SandstormReportCodepage": "Code page",
  "SandstormReportLanguage": "Language",
  "SandstormReportDllname": "DLL name",
  "SandstormReportApis": "APIs",
  "SandstormReportImportbyordinal": "By ordinal?",
  "SandstormReportDescription": "Description",
  "SandstormReportSeverity": "Severity",
  "SandstormReportDetailCategory": "Detail category",
  "SandstormReportDetailData": "Detail data",
  "SandstormReportSignatureCerts": "Signature and certificates",
  "SandstormReportDocumentContent": "Document content",
  "SandstormReportSubject": "Subject",
  "SandstormReportComments": "Comments",
  "SandstormReportNumChars": "Number of characters",
  "SandstormReportLines": "Number of lines",
  "SandstormReportParagraphs": "Number of paragraphs",
  "SandstormReportContentType": "Content type",
  "SandstormReportNumPages": "Number of pages",
  "SandstormReportTemplate": "Template",
  "SandstormReportSigned": "Signed",
  "SandstormReportNotSigned": "Not signed",
  "SandstormReportNotSpecified": "Not specified",
  "SandstormReportFeatureAnalysis": "Feature analysis",
  "SandstormReportFeatureAnalysisLine1": "Identifies specific features of the file",
  "SandstormReportFeatureAnalysisLine2": "Randomly selects ten million known bad files from our data warehouse",
  "SandstormReportFeatureAnalysisLine3": "Counts the number of good and bad sample files that have the same features. These simple counts are shown in the graph below.",
  "SandstormReportFeatureAnalysisLine4": "The final verdict may also take into account more complex combinations of features",
  "SandstormReportFeatureCombo": "Feature combinations",
  "SandstormReportFeatureComboLine1": "Counts the number of good and bad sample files that have one feature in common with your file",
  "SandstormReportFeatureComboLine2": "Adds an additional feature and counts the sample files that have both features",
  "SandstormReportFeatureComboLine3": "Continue adding features and counting sample files that combine all features",
  "SandstormReportFeatureComboLine4": "Combinations of features can provide a more precise indication than individual features",
  "SandstormReportYourFile": "Your file",
  "SandstormReportBadFile": "Bad file",
  "SandstormReportGoodFile": "Good file",
  "SandstormReportGenes": "Genes",
  "SandstormReportMlHeader": "Overall verdict based on the Sophos deep learning model",
  "SandstormReportMlLine1": "Our model identifies many attributes of the file and compares their occurrence, individually and in different combinations, with millions of known good and known malware samples.",
  "SandstormReportMlLine2": "The reports below show probabilities based on key components of the overall score. Each component isn’t a strong indicator on its own but, in combination, they provide a critical insight.This model identifies many different characteristics of your file and compares the occurence of those characteristics, individually and in combinations, across millions of known good and known malware samples.",
  "SandstormReportStructureAnalysis": "Structure analysis",
  "SandstormReportStructureAnalysisLine1": "Identifies {number_of_genes} distinctive structural genes in the file",
  "SandstormReportStructureAnalysisLine2": "Scans Sophos database for files with these genes",
  "SandstormReportStructureAnalysisLine3": "Ascertains the likelihood of the genes\' presence in good versus malicious files",
  "SandstormReportStructureAnalysisLine4": "The chart below shows {row_count} of the files in the sample set with the strongest genetic match",
  "SandstormReportReputationLine1": "We use live cloud lookups to ascertain file reputation based on how widely the file has been seen. This enables us to block emerging, fast-moving threats while preventing false positives.",
  "SandstormReportReputationScore": "Reputation score",
  "SandstormReportVerdictComment": "Verdict comment",
  "SandstormReportReputationFirstSeen": "First seen",
  "SandstormReportReputationLastSeen": "Last seen",
  "SandstormReportReputationPrevalence": "Prevalence",
  "SandstormReportStronger": "Stronger",
  "SandstormReportMatch": "Match",
  "SandstormReportWeaker": "Weaker",
  "SandstormReportFilenameNotAvailable": "Filename not available",
  "SandstormReportClickToClose": "Click to close screenshot",
  "SandstormReportClickAnywhereToClose": "Click anywhere to close",
  "SandstormReportZoom": "Zoom",
  "SandstormReportWritten": "Written",
  "SandstormReportVTVerdict": "Identified as malicious by {vtbad} out of {vtTotal} malware detection products.",
  "SandstormReportVTReport": "VirusTotal report",
  "SandstormReportVTLink": "VirusTotal link",
  "SandstormReportVTLabel": "VirusTotal detection",
  "SandstormReportTimeOfAnalysis": "Time of analysis",
  "SandstormReportStatic": "File analysis",
  "MailSpoolSandboxRetryRoleSuccess": "Re-sent some emails. To resend the rest, you need read-write permission for threat intelligence.",
  "MailSpoolSandboxDeleteRoleSuccess": "Deleted some emails. To delete the rest, you need read-write permission for threat intelligence.",
  "MailSpoolSandboxRetryRoleSingleDeleteFail": "Couldn't delete emails. You don't have read-write permission for threat intelligence.",
  "MailSpoolSandboxRetryRoleSingleRetryFail": "Couldn't resend emails. You don't have read-write permission for threat intelligence.",
  "ReleasedBeforeNegativeVerdict": "This file was manually released before analysis was complete. Based on the analysis result this file would have been blocked. The host may be at risk.",
  "APACSandstormDataCenter": "Asia Pacific",
  "DefaultSandstormDataCenter": "Let Sophos decide (recommended)",
  "DESandstormDataCenter": "Europe (Frankfurt)",
  "EUSandstormDataCenter": "Europe (London)",
...
*************************************************************************************/
  ...
  "AddRuleConfirm": "Add rule {fwrule} to the group {group}?",
  "AddMultiRuleConfirm": "Add rules to the group {group}?",
  "DetachLastFirewallRuleConfirm": "You are about to detach all the firewall rules in the group. Detaching all the rules will also delete the group.",
  ...
  "AddNwAbove": "Add rule above",
  "AddBusinessAbove": "Add a business rule before this",
  "AddNwBelow": "Add rule below",
  ...
  "FwSrcHeartbeat": "Src Security Heartbeat",
  "FwDstHeartbeat": "Dst Security Heartbeat",
  "FwSrcHeartbeatLabel": "Src HB:",
  "FwDstHeartbeatLabel": "Dst HB:",
  "FwSrcLabel": "Src networks/devices",
  "FwDstLabel": "Dst networks/devices",
  "FwGoogleQuic": "Google QUIC",
  "FwSandstorm": "Sandstorm",
  "FwHBReq": " Heartbeat required",
  "FwSelectOne": "Select an option",
  "FwPleaseEnterVal": "Enter a value",
  "FwNoEnforcement": "Not enforced",
  "FwFTPMalwareScan": "FTP malware scan",
  "FwAppControl": "Application control",
  "Contains": "contains",
  "is": "is",
  "StartsWith": "starts with",
  "Allowed": "Allowed",
  "Blocked": "Blocked",
  "SelectableText": "Selectable dropdown with policy names",
  "NonePolicyApplied": "None",
  "NoGroup": "Not part of a group",
...
*****************************/
  ...
  "CustomBlockMessage": "Block message",
  "UseCustomBlockMessage": "Use custom block message",
  "PreviewBlockMessage": "Preview block message",
  "CustomOverrideMessage": "Override message",
  "UseCustomOverrideMessage": "Use custom override message",
  "PreviewOverrideMessage": "Preview override message",
  "CustomQuotaMessage": "Quota message",
  "UseCustomQuotaMessage": "Use custom quota message",
  "PreviewQuotaMessage": "Preview quota message",
  "CustomWarnMessage": "Warn message",
  ...
  "WarnSkippedRequiredFilterRules":
    "The list of skipped filter rules contains the following required infrastructure rules:"
    + "<br>"
    + "<ul>"
    + "{skippedRequiredFilterRules}"
    + "</ul>"
    + "Disabling a required infrastructure rule can lead to attacks not being blocked by web server protection.",
  ...
  "Malware": "Malware",
  "ContentScanningRules": "Malware and content scanning",
  ...
  "WPLocalwifi1name": "Can’t edit the name here, since the network’s assigned to LocalWi-Fi1 (optional Wi-Fi). To change the name, go to Wireless > Wireless networks.",
  ...
  "PolicyRouteEnableConfirm": "Turn on SD-WAN policy route?",
  "PolicyRouteDisableConfirm": "Turn off SD-WAN policy route?",
  "disableSuccessMessagePolicyRoute": "Turned off SD-WAN policy route.",
  "enableSuccessMessagePolicyRoute": "Turned on SD-WAN policy route.",
  "PolicyRouteDisableFailed": "Couldn't turn off SD-WAN policy route.",
  "PolicyRouteEnableFailed": "Couldn't turn on SD-WAN policy route.",
  "Vendor": "Vendor",
  ...
  "SyncAppDisabled": "Synchronized Application Control is turned off",
  ...
  "EnhancedApplication": "Synchronized application",
  ...
  "CnfMoveRule": "Move the rule?",
  "CnfMoveGroup": "Move the group?",
  "CnfMoveRuleLast": "Moves rule to the last position.<br>Move the rule?",
  "CnfMultiFwDel": "Deletes the selected rules.<br>(Deleting a group deletes rules in the group.)<br>Want to delete?",
  "ConnectedFrom": "Connected from",
  ...
  "VLANHelp": "For VLAN ID, enter a number or range (example: 20—35).",
  "PermittedVLANs": "Permitted VLAN ID or ID range",
  "EnableFilterVLANs": "Filter VLANs",
  ...
  "DisplayFwCount": "Showing {currentpage} of {total}. Selected {selected}",
  "Algorithm": "Algorithm",
  ...
  "SelectedWebserverWAF": "Selected web servers",
  "CPCustomizationHELPPoint1": "1. For customization to work properly, it is compulsory to have one &lt;div&gt; element with ID \"__loginbox\" in HTML, i.e &lt;div id=' __loginbox'&gt;",
  "CPCustomizationHELPPoint2": "2. System will render necessary user input elements in above mentioned div. You can customize those elements using CSS and JavaScript.",
  "CPCustomizationHELPPoint3": "3. In the preview it may be that you may not find it completely as per the HTML as JavaScript is not executing.",
  ...
  "BridgeACLs": "Bridge ACLs",
  "ARPBroadcastFilter": "ARP broadcast",
  "Ethertypefiltering": "EtherType filtering",
  "VLANfiltering": "VLAN filtering",
  ...
  "DestinationAndServices": "Destination and services",
  "DestinationAndServicesWhitelistDescription":"All destination zones, networks, and services matched",
  "SourceWhitelistDescription":"All source zones, networks, devices, users, and groups matched",
  ...
  "ExSrcZones": "Source zone exclusions",
  "DstZones": "Destination zones",
  "ExDstZones": "Destination zone exclusions",
  "DstNetworks": "Destination networks",
  "ExDstNetworks": "Destination network exclusions",
  "AddExclusion": "Add exclusion",
  "Exclusions": "Exclusions",
  "Excluded": "Excluded",
  "ExclusionInfo": "Specify the criteria that you don't want to match for this rule. The firewall traverses the rule table further for the excluded criteria.",
  "SrcNetworksAndDevices": "Source networks and devices",
  "ExSrcNetworksAndDevices": "Source network and device exclusions",
  ...
  "UseWebAuth": "Use web authentication for unknown users",
  "BasicSetup2": "Basic setup",
  "HAAuxConfiguration": "Configure auxiliary HA device",
  "Back2": "Back",
  "SaveChanges": "Save changes",
  ...
  "BlockQuickQuicLabel": "Block QUIC protocol",
  ...
  "npNATDetail" : "#NAT_Default_Network_Policy Linked NAT rule has been created with MASQ Source Translation.",
  "NetworkProtection": "Network protection",
  ...
  "ManageFromCentral": "Sophos Central services",
  "CentralTitleDescription": "Manage and monitor firewall from Sophos Central<br/><br/>Turn on flexible reporting and log storage in Sophos Central",
  ...
  "CentralPopupTitle": "Firewall Management and Reporting from Sophos Central",
  "CentralPopupMsg1": "To manage and monitor the firewall from Sophos Central, click Apply.",
  "CentralPopupMsg2": "Next step: Sign in to Sophos Central and click \"Accept services\"",
  "CentralBackup": "Send configuration backup to Sophos Central",
  "useCentralReporting" : "Use Sophos Central reporting",
  "useCentralManagement" : "Use Sophos Central management",
  "firewallManagedMonitored": "The firewall is being managed from {firewallManagement}. To move the firewall management and monitoring to Sophos Central, click Apply.",
  "Managed": "Managed",
  ...
  "MigratedIPv4Policy": "Migrated IPv4 SD-WAN policy route",
  "MigratedIPv6Policy": "Migrated IPv6 SD-WAN policy route",
  "MigratedPolicyRouteMsg": "Created the SD-WAN policy route to migrate an earlier version that has route through gateway configuration.",
  "FWInformation": "Firewall rule information",
  "DKIMSigning": "DKIM signing",
  "DKIMKeySelector": "Key selector",
  "DKIMPrivateRSAKey": "Private RSA key",
  "DKIMPrivateKeyLengthValidate": "Private RSA key must be between 1024 and 2048",
  "EncryptPassword": "Encrypt backup with password",
  "AcceptQueries": "Accept queries",
  "SendTraps": "Send traps",
  "AuthorizedHosts": "Authorized hosts",
  "EncrptionAlgo": "Encryption algorithm",
  "UserAddTitle": "Add user",
  "UserEditTitle": "Edit user",
  "Query": "Query",
  "SNMPv3UsersAndTraps": "SNMPv3 users and traps",
  "EncryptionAlgorithm": "Encryption algorithm",
  "AuthenticationAlgorithm": "Authentication algorithm",
  "SNMPv1v2cCommunityAndTraps": "SNMPv1 and v2c community and traps",
  "OverrideGatewayInfo": "Routes to the selected gateway. Ignores gateway status.",
  "OverrideGateway": "Override gateway monitoring decision",
  "DKIMVerification": "DKIM verification",
  "DKIMInvalid": "Invalid DKIM signature",
  "DKIMFailed": "DKIM verification failed",
  "DKIMNone": "No DKIM signature found",
  "DKIM": "DKIM",
  "OverrideGatewayInfo": "Routes to the selected gateway. Ignores gateway status.",
  "OverrideGatewayStatus": "Override gateway monitoring",
  "EncryptPassword": "Encrypt backup with password",
  ...
  "QuarantineDiskSize":"Quarantine area",
  "QuarantineSize":"Disk size",
  "FiveGB":"5 GB",
  "TenGB":"10 GB",
  "FifteenGB":"15 GB",
  "QuarantineAdminSet":"Release link settings",
  "ReleaseLinkHelp": "The hostname is a firewall or user-specified hostname. To change the settings,<br/> go to Administration > Admin settings > Admin console and end-user interaction.",
  "RejectOnBATV": "Reject based on BATV",
  "BATVsecret": "BATV secret",
  "ShowBATVsecret": "Show secret",
  "DEDICATED_INTERFACE_UNPLUGGED": "Some dedicated interfaces are unplugged",
  "RAID_DEFECTIVE_HARD_DISK": "Raid degraded. Inserted defective hard disk",
  "RAID_REBUILD_STARTED": "Started RAID rebuild process",
  "IPS_ALERT_CRITICAL": "Critical",
  "IPS_ALERT_MAJOR": "Major",
  "IPS_ALERT_MODERATE": "Moderate",
  "IPS_ALERT_MINOR": "Minor",
  "IPS_ALERT_WARN": "Warning",
  "ADVANCE_THREAT_PROTECTION_ALERT": "Alert",
  "ADVANCE_THREAT_PROTECTION_DROP": "Drop",
  "CONFIG_DISK_USAGE_EXCEEDED": "Configuration disk usage exceeded threshold",
  "SIG_DISK_USAGE_EXCEEDED": "Signature disk usage exceeded threshold",
  "REPORT_DISK_USAGE_EXCEEDED": "Reports disk usage exceeded threshold",
  "PHYSICAL_MEMORY_USAGE_EXCEEDED": "Usage exceeded physical memory",
  "SWAP_MEMORY_USAGE_EXCEEDED": "Usage exceeded swap memory",
  "NEW_FIRMWARE_READY_FOR_INSTALL": "New firmware ready for installation",
  "NEW_FIRMWARE_INSTALLED": "Installed new firmware",
  "NEW_FIRMWARE_INSTALL_FAILED": "Firmware installation failed",
  "WEBCAT_UPGRADE_FAILED": "WebCat database upgrade failed",
  "IPS_SIG_UPGRADE_FAILED": "IPS signature upgrade failed",
  "AV_UPGRADE_FAILED": "Antivirus definition upgrade failed",
  "SYSTEM_RESTARTED": "System started",
  "HIGH_CPU_USAGE": "High CPU usage",
  "GATEWAY_STATUS": "Gateway status",
  "RED_CONNECTION_DOWN": "RED connection is down",
  "RED_FIRMWARE_UPGRADE_FAILED": "RED firmware upgrade failed",
  "AP_OFFLINE": "Access point is offline",
  "AP_UPGRADE_FAILED": "Access point firmware upgrade failed",
  "TOO_MANY_LOGIN_FAILED": "Too many failed sign-in attempts",
  "LOGIN_FAILED": "Sign-in failed",
  "MONITOR_INTERFACE_UNPLUGGED": "Port monitored by HA appliance is unplugged",
  "RAID_HARD_DISK_REPLACEMENT_NEEDED": "RAID degraded. We recommend hard disk replacement.",
  "NotificationsList": "Notification list",
  "IPSecTunnelUpLbl": "IPsec tunnel is up",
  "IPSecTunnelDownLbl": "IPsec tunnel is down",
  "SSL_VPN_UP":"Established SSL VPN connection",
  "SSL_VPN_DOWN":"Disconnected SSL VPN connection",
  /*NAT Rule Page start */
  "FeaturesAndService": "Feature and service",
  "RulesPolicies": "Rules and policies",
  "Inbound": "Inbound",
  "Outbound": "Outbound",
  "OutboundInfoText": "Configured different source translation for some outbound interfaces.",
  "UsageCount": "Usage count",
  "CnfMoveNATRule": "Want to move NAT rule?",
  "UnlinkRule": " Unlink rule",
  "AddNATruleBefore": "Add rule above",
  "AddNATruleAfter": "Add rule below",
  "ResetUsageCounter": " Reset usage count",
  "UnlinkConfirm": "Want to unlink the selected records?",
  "NATType": "NAT type",
  "HideLinkedNATRule": "Hide linked NAT rule",
  "LinkedNATRule": "Linked NAT rule",
  "lastUsed": "Last used",
  "linkedFW": "Linked with firewall",
  "fwRuleID": "Firewall rule ID",
  "meterInfo": "Number of connections translated, using this rule",
  "NoNAT": "No NAT",
  "enableNATConfirm": "Want to turn on NAT rule?",
  "disableNATConfirm": "Want to turn off NAT rule?",
  "disableNATSuccessMessage": "Turned off NAT rule",
  "disableNATFailedMessage": "Couldn't turn off NAT rule",
  "AddNATPolicy": "Add NAT rule",
  "Original": "Original",
  "Translated": "Translated",
  /*NAT Rule Page start */
  "Notifications": "Notifications",
  "AuthenticationPassword": "Authentication password",
  "v1Andv2": "SNMPv1 and SNMPv2c",
  "selectValidIPForManagmentInterface": "Select a management interface with valid IP address.",
  "HTTP_VIRUS_ALERT": "HTTP virus alert",
  "FTP_VIRUS_ALERT": "FTP virus alert",
  "SMTP_VIRUS_ALERT": "SMTP virus alert",
  "POP3_VIRUS_ALERT": "POP3 virus alert",
  "IMAP4_VIRUS_ALERT": "IMAP4 virus alert",
  /* Feedback form */
  "Features": "Feature or Service",
  "Impact": "Severity or Impact",
  "EmailAddressContact": "Your email address",
  "SummaryDescription": "Enter a brief overview of the issue",
  "Details": "Details",
  "DetailsDescription": "Follow the above suggestions and give us the complete detail",
  "TroubleshootReport": "Attach troubleshooting report",
  "Send": "Send",
  "ConfirmSend": "Submit form?",
  "productFeatures": ["Control center", "Current activities", "Reports", "Diagnostics", "Firewall", "Intrusion prevention", "Web", "Applications", "Wireless", "Email", "Web server", "Advanced threat", "Central synchronization", "VPN", "Network", "Routing", "Authentication", "System services", "Profiles", "Hosts and services", "Administration", "Backup and firmware", "Certificates", "Others"],
  "impact": ["High", "Medium", "Low", "Minimal"],
  "Feedback": "Feedback",
  "FeedbackTitle": "XG Firewall EAP: Report of your problem or suggestion",
  "IPUnconfigured":"No IP address",
  "SNMPNotification":"SNMP traps",
  ...
  "sec20":"20 seconds",
  "sec30":"30 seconds",
  "DDNSrefreshIntervalMsg":"The firewall checks for a change in the server IP address every 5 minutes.",
  /* End of Feedback form */
   "AppFilterObject":"Application object",
   "AFObjectAdd":"Create application object",
   "AFObjectUpdate":"Update application object",
   "ObjectName":"Object Name",
  /* Firewall NAT Improvement */
  "LogExampleTxt": "Logs traffic, matching this firewall rule, on the appliance (by default) or on the configured syslog server.",
  "SourceDetailTxt" : "Select the source zones, networks, and devices.<br>The rule applies to traffic from these sources during the scheduled time period.",
  "DstDetailTxt" : "Select the destination zones, networks, devices, and services.<br>The rule applies to traffic to these destinations.",
  "ScheduleDetailTxt" : "Select to apply the rule to a specific time period and day of the week",
  "ServiceExampleTxt" :"Services are traffic types based on a combination of protocols and ports.",
  "FurtherSecurityFeature":"Other security features",
  "EmailContentScan":"Scan email content",
  "PreconfiguredTemplate":"Preconfigured template",
  "AppLabel":"Identify and control applications (App control)",
  "IpsLabel":"Detect and prevent exploits (IPS)",
  "NatLinkLabel":"Linked NAT Policy",
  "TrafficShapeLabel":"Shape traffic",
  "EmailCommonPortTxt": "To add standard {Text} ports to Services, click .&nbsp; <b><u>Add Ports</u></b>",
  "SecurityFeatures":"Security features",
  "HeartbeatHeading":"Configure Synchronized Security Heartbeat",
  "EditNATPolicy": "Edit NAT rule",
  "EnableRule":"Enable rule",
  "DisableRule":"Disable rule",
  "RuleStatus":"Rule status",
  "TranslationSettings":"Translation settings",
  "NATDescription":"Select the matching criteria and translation settings for source, destination, and services.",
  "LoopbackPolicy":"Create loopback policy",
  "ReflexsivePolicy":"Create reflexive policy",
  "NATMethod":"Load balancing method",
  "HealthcheckProbing":"Health check",
  "AnyInterface": "Any interface",
  "ProbeInterval": "Probe interval",
  "ResponseTimeout": "Response time-out",
  "DeactivateHostafter":"Deactivate host after",
  "retries":"retries",
  "ProbeExample" : "5-65535 seconds",
  "ResponseExample" : "1-10 seconds",
  "RetriesExample" : "1-10 retries",
  "OriginalSource": "Original source",
  "OriginalDestination":"Original destination",
  "OriginalService":"Original service",
  "TranslatedService":"Translated service",
  "InboundInterface": "Inbound interface",
  "OutboundInterface": "Outbound interface",
  "skipDestinationLabel" : "Do not apply this migrated rule to system-destined  traffic.",
  "skipHover":"Retains rule behavior of earlier versions, in which system-destined traffic was unaffected by rules with matching zones.<br> Read-only configuration for migrated rule.",
  "overrideHover":"Configure different source NAT for specific outbound interfaces in the single NAT rule.",
  "loopbackHover":"Internal users will access an internal server, using its public IP address or domain name.",
  "reflexiveHover":"Translates outgoing traffic from internal sources, for example, from a protected server to the internet.",
  "retriesforhost":"retries before deactivating a host",
  "ValidProbeInterval": "Probe interval must be from 5 to 65535 seconds.",
  "ValidResponseTimeOut": "Response time-out must be from 1 to 10 seconds.",
  "ValidDeactivatingRetries": "Number of retries before deactivating a host must be from 1 to 10.",
  "unLinkRuleConfirm":"Unlink firewall rule?",
  "OnetoOne": "One-to-one",
  "OSourceNotSelected":"Select an original source.",
  "ODestinationNotSelected":"Select an original destination.",
  "OServiceNotSelected":"Select an original service.",
  "InboundNotSelected":"Select an inbound interface.",
  "OutboundNotSelected":"Select an outbound interface.",
  "NATmethodNotallowed":"Can’t apply NAT method. Translated destination must have more than one IP address.",
  "SelectNATMethod":"Select a NAT method.",
  "OnetoOneNotallowed":"To apply one-to-one NAT method, you must specify an IP range for original and translated destinations.",
  "InvalidDestinationCombination":"Invalid translated destination",
  "Servicevalidation1":"You've specified Any for original service. Translated service must be set to Original.",
  "Servicevalidation2":"Original and translated services don't match.",
  "Servicevalidation3":"Type of original service must be TCP/UDP.",
  "Servicevalidation4":"You've specified more than one original service. Translated service must be set to Original.",
  "Servicevalidation5":"Specify a single translated service port or equal to the number of original service ports.",
  "Servicevalidation6":"Specify the same protocol for original and translated services.",
  "InvalidServiceCombination":"Invalid translated service",
  "LoopbackDescription" : "Loopback rule for NAT rule with ID {id} and rule name {name}.",
  "ReflexiveDescription" : "Reflexive rule for NAT rule with ID {id} and rule name {name}.",
  "MaxRuleErrMessage" : "You need to select fewer than 200 rules at a time.",
  "InterfaceMatchingCriteria" : "Interface matching criteria",
  /* Firewall NAT Improvement End */
  "OvertheairHotfix" : "Hotfix",
  "InvalidValueClusterId": "Invalid value of {fieldname}, it should be between {minvalue} to {maxvalue}",
  "ClusterId": "Cluster ID",
  "HaClusterRange": " (0-63)",
  "DisableVmacLable":"Use host or hypervisor-assigned MAC <br/>address",
  "HADisablevmacHelp":"You don’t need to turn on promiscuous mode on the vSwitch.",
  "BATVHide":"Hide",
  "HighAvailabilityStatus": "High availability status",
  "HAStatusText":"Requires approximately four minutes to configure HA.",
  "QuickMode":"QuickHA mode",
  "InteractiveMode":"Interactive mode",
  "FallbackToPrimary":"Fail back to primary device after it recovers",
  "PeerAdminSettings":"Peer administration settings",
  "AuxPeerAdminSettings":"Auxiliary device administration settings",
  "SendKeepAliveRequst":"Send a request every",
  "Seconds3to300": "milliseconds (250-500)",
  "WaitFor":"Make",
  "KeepAliveAttempt":"attempts before determining it as device failure (16-24)",
  "Keepalivefailure": "Keepalive attempts",
  "Keepaliveinterval": "Keepalive request interval",
  "Primary_Active_Active": "Primary (Active-Active)",
  "Primary_Active_Passive": "Primary (Active-Passive)",
  "PeerAdminPortandIPrequired": "Enter a peer administration IP address.",
  "DuplicatePeerIPandAdmin": "Can’t specify a peer administration port or IP address more than once.",
  "DuplicateBridgePort":"Can’t specify a bridge interface more than once.",
  "SerialNo":"Serial number",
  "PeerApp":"Peer",
  "UpdateHAConfirmMsg": "Update HA configuration?",
  "Passive":"Passive",
  "HANotConfigured":"HA not configured",
  "HAConfigured":"HA configured",
  "HANotDetected":"No HA link detected",
  "HAPeerNotDetected":"No peer detected",
  "PeerDetected":"Peer detected",
  "InitialSyncInProgress":"Initial sync in progress",
  "QuickModeError":"Unable to find a dedicated HA port.",
  "InitialRole":"Device role",
  "NATID": "NAT ID",
  "VPNtraffic":"VPN tunnel traffic",
  "NATRule": "NAT rule",
  "Configured": "Configured",
  "NotConfigured": "Not configured",
  "emailAlertTooltipMessage": "To turn on email notifications, go to System services > Notification list.",
  "SNMPAlertTooltipMessage": "To turn on SNMP traps, go to System services > Notification list.",
  "emailSettingsTooltipMessage": "To specify email notification settings, go to Administration > Notification settings.",
  "SNMPSettingsTooltipMessage": "To specify SNMP settings, go to Administration > SNMP.",
  "SNMPHostIPExceed": "You can specify a maximum of \"{number}\" authorized hosts.",
  "FilterEthernetFrames":"Filter Ethernet frames",
  "EthernetFrameTypes":"Forwarded Ethernet frame types",
  "EthernetTypesTooltipMessage":"You can specify additional EtherTypes that the bridge must forward transparently. For types, enter the 4-digit <br>hexadecimal ID, for example, AppleTalk type 809B, Novell type 8138, PPPoE types 8863 and 8864.",
  "XGManagedByCentral": "The firewall is managed through Sophos Central. Do not change the configuration locally. It may result in a conflict.",
  "XGRebootOnTransactionExec": "Couldn’t apply the configuration. XG Firewall rebooted or shut down during the process. Try again.",
  "BridgeMTUToolTip": "Actual bridge MTU may be lower than the configured value. It inherits the<br> bridge member (example: VLAN) value that’s lower than the configured value.<br>See the inherited MTU value in the interface table.",
  "NeitherIPV4orIPV6": "Connection is neither from IPv4 or IPV6 interface",
  "StopDiscovery":"Stop QuickHA discovery",
  "StopDiscConfirmMsg": "Stop discovery of QuickHA?",
  "BridgePeerAdminPort":"Reserve bridge port",
  "bridgeAdminCheck":"For all the bridge interfaces selected in peer administration settings, specify peer admin ports.",
  "bridgeAdminportCheck":"Specify peer admin ports only for the bridge interfaces selected in peer administration settings.",
  "EmptySearchContent": "Enter a search term.",
  "NoFilterToClear": "You haven’t applied a filter.",
  "STPHAConfWarning":"Can't turn on STP when HA is configured.",
  "HASTPConfWarning":"Can't configure HA when you've turned on STP on a bridge interface.",
  "HAIPV4NotConfigured":"To configure an IPv4 address, select an IPv4 interface.",
  "HAIPV6NotConfigured":"To configure an IPv6 address, select an IPv6 interface.",
  "HAmultiplebridge":"Can't add more than one bridge interface.",
...
var Message = {
  ...
  "BrPairEditBridgePairNameConflict": "Hardware name \"{interface}\" exists as a specified or system-reserved name. Specify a different name.",
  "BrPairEditBridgeParentChildInterface": "VLAN and the parent interface can't be part of the same bridge",
  "BrPairMaxMemberLimit": "Reached maximum limit of allowed members",
  ...
  "BrPairEditRemoveOldMemberFailed": "Couldn’t remove bridge member. Contains a VLAN that’s part of another bridge.",
  ...
  "CertManageChildExists": "Couldn't delete certificate. It's in use in an IPsec, L2TP or SSL VPN connection.",
  "CertDeleteLdapFailed": "Couldn't delete certificate. It's in use in the LDAP server.",
  "CertDeleteEdirectoryFailed": "Couldn't delete certificate. It's in use in the eDirectory server.",
  "CertDeleteAdminSettingFailed": "Couldn't delete certificate. It's in use as the admin console certificate.",
  "CertDeleteHotspotFailed": "Couldn't delete certificate. It's in use in a hotspot.",
  "CertDeleteChromeBookSSOFailed": "Couldn't delete certificate. It's in use in Chromebook SSO.",
  ...
  "ClientlessUserForeignKeyExists": "Clientless user could not be deleted. A firewall rule, web policy rule or SSL/TLS inspection rule exists for this user.",
  ...
  "CorpSpamDigestUpdateSucc": "Updated quarantine settings",
  "CorpSpamDigestUpdateFail": "Couldn't update quarantine settings",
  ...
  "InterfaceNameExists": "Interface name exists.",
  ...
  "UserportalAuthSettingsSuccess": "Updated authentication settings of user portal",
  "UserportalAuthSettingsFail": "Couldn't update authentication settings of user portal",
  ...
  "WebAuthSettingsCapPortalSuccess": "Updated captive portal settings",
  "WebAuthSettingsCapPortalFail": "Couldn't update captive portal settings",
  ...
  "NATRuleDeleteFail": "Couldn't delete NAT rule",
  ...
  "FWRuleenableSuccess": "Turned on firewall rules",
  "FWRuleenableFailed": "Couldn't turn on firewall rules",
  "NATRuleenableSuccess": "Turned on NAT rule",
  "NATRuleenableFailed": "Couldn't turn on NAT rule",
  ...
  "FirmwareV18Need4GBRAM": "The new firmware requires you to allocate at least 4 GB of RAM to virtual and software environments. You must allocate the required RAM before you can upgrade.",
  ...
  "FQDNHGPolicyRouteExists": "Couldn't delete FQDN host group. SD-WAN policy route exists for the group.",
  ...
  "InterfaceEditBridgeMemFailed": "Couldn't update member interface \"{name}\"",
  ...
  "InterfaceAddVLANSuccess": "Added VLAN interface \"{name}\"",
  ...
  "InterfaceUpdateSuccess": "Updated interface \"{name}\"",
  ...
  "VlanOfBridgePairMembersExist": "Couldn’t delete interface. Bridge member interfaces (RED or LAG) contain a VLAN that’s part of another bridge.",
  "LAG_VLAN_EXIST_IN_BRIDGE": "Couldn’t delete LAG interface. Contains a VLAN that’s part of a bridge.",
  "RED_VLAN_EXIST_IN_BRIDGE": "Couldn’t delete RED interface. Contains a VLAN that’s part of a bridge.",
  ...
  "InterfaceEditBridgeMemSuccess": "Updated member interface \"{name}\"",
  ...
  "ServiceGrpPolicyRouteExists": "Couldn't delete service group. SD-WAN policy route exists for the group.",
  ...
  "ServicePolicyRouteExists": "Couldn't delete service. SD-WAN policy route exists for the service.",
  ...
  "UserForeignKeyExists": "User could not be deleted. A firewall rule, VPN connection, web policy rule or SSL/TLS inspection rule exists for this user.",
  ...
  "VLANAddFailed": "Couldn't add VLAN interface \"{name}\"",
  "VLANRecordExists": "VLAN interface could not be added. IP address or VLAN ID already exists",
  "VLANUpdateFail": "Couldn't update VLAN interface \"{name}\"",
  ...
  "VLANZoneRequired": "Couldn't add VLAN interface \"{name}\". Select the zone",
  ...
  "WFCAddSuccess": "Created the web category",
  "WFCAddFailed": "Couldn't create the web category",
  "WFCRecordExist": "Web category with this name exists. Choose a different name",
  "WFCEditSuccess": "Updated the web category",
  "WFCEditFailed": "Couldn't update the web category",
  ...
  "TlsRuleAddSuccess": "SSL/TLS inspection rule \"{name}\" has been created successfully.",
  "TlsRuleAddFailed": "SSL/TLS inspection rule \"{name}\" could not be created.",
  "TlsRuleRecordExists": "SSL/TLS inspection rule could not be created. SSL/TLS inspection rule with the same name as \"{name}\" already exists, choose a different name.",
  "TlsRuleUpdateRecordExists": "SSL/TLS inspection rule could not be updated. SSL/TLS inspection rule with the same name as \"{__newname}\" already exists, choose a different name.",
  "TlsRuleUpdateSuccess": "SSL/TLS inspection rule \"{__newname}\" has been updated successfully.",
  "TlsRuleUpdateFailed": "SSL/TLS inspection rule \"{name}\" could not be updated.",
  "TlsRuleDeleteSuccess": "SSL/TLS inspection rule has been deleted successfully.",
  "TlsRuleDeleteFailed": "SSL/TLS inspection rule could not be deleted.",
  "TlsRulesLimit": "Maximum number of SSL/TLS inspection rules has been reached.",
  "TlsRuleOrderUpdateSuccess": "SSL/TLS inspection rule order has been updated successfully.",
  "TlsRuleOrderUpdateFailed": "SSL/TLS inspection rule order could not be updated.",
  "TlsRuleEnableSuccess": "SSL/TLS inspection rule has been enabled successfully.",
  "TlsRuleEnableFailed": "SSL/TLS inspection rule could not be enabled.",
  "TlsRuleDisableSuccess": "SSL/TLS inspection rule has been disabled successfully.",
  "TlsRuleDisableFailed": "SSL/TLS inspection rule could not be disabled.",

  "TlsSettingsUpdateSuccess": "SSL/TLS inspection settings have been updated successfully.",
  "TlsSettingsUpdateFailed": "SSL/TLS inspection settings could not be updated.",

  "DecryptionProfileAddSuccess": "Decryption profile \"{name}\" has been created successfully.",
  "DecryptionProfileAddFailed": "Decryption profile \"{name}\" could not be created.",
  "DecryptionProfileRecordExists": "Decryption profile could not be created. Decryption profile with the same name as \"{name}\" already exists, choose a different name.",
  "DecryptionProfileUpdateRecordExists": "Decryption profile could not be updated. Decryption profile with the same name as \"{__newname}\" already exists, choose a different name.",
  "DecryptionProfileUpdateSuccess": "Decryption profile \"{__newname}\" has been updated successfully.",
  "DecryptionProfileUpdateFailed": "Decryption profile \"{name}\" could not be updated.",
  "DecryptionProfileDeleted": "Decryption profile has already been deleted.",
  "DecryptionProfileDeleteSuccess": "Decryption profile has been deleted successfully.",
  "DecryptionProfileDeleteFailed": "Decryption profile could not be deleted.",
  "DecryptionProfilesLimit": "Maximum number of decryption profiles has been reached.",
  ...
  "CountryGrpPolicyRouteExistsMessage": "Couldn't delete country group. SD-WAN policy route exists for the group.",
  ...
  "NATDelSuccess": "Deleted NAT rule",
  "RowUpdate": "Updated the rule position.",
  "RowUpdateToGroup": "Updated the rule position. Attached rule to a group.",
  "RowUpdateFail": "Couldn't update the rule position.",
  "NATRowUpdate": "Updated NAT rule position",
  "NATRowUpdateFail": "Unable to move NAT rule",
  ...
  "VLANUpdateSuccessMessage": "Updated VLAN interface \"{name}\"",
  ...
  "NTLMSettingSuccessMsg": "AD SSO settings have been applied successfully",
  "NTLMSettingFailMsg": "AD SSO settings could not be applied",
  ...
  "SysServerReservedName": "\"Central_Management\" and \"Central_Reporting\" are names reserved for \"Syslog servers\". Specify a different name.",
  ...
  "IPTunnelAddSuccess": "IP tunnel \"{displayname}\" has been created successfully",
  "IPTunnelAddFail": "IP tunnel \"{displayname}\" could not be created",
  "IPTunnelRecordExists": "Hardware name \"{name}\" exists as a specified or system-reserved name. Specify a different name.",
  "IPTunnelSameLocalRemoteAdd": "IP tunnel could not be created. A tunnel with the same endpoint(s) already exists",
  "IPTunnelUpdateSucc": "IP tunnel \"{displayname}\" has been updated successfully",
  "IPTunnelUpdateFail": "IP tunnel \"{displayname}\" could not be updated",
  ...
  "InterfaceReservedName": "This is a system-reserved interface name. Specify a different name.",
  ...
  "LAGNameConflict": "Hardware name \"{interfacename}\" exists as a specified or system-reserved name. Specify a different name.",
  ...
  "LAGMemberInterfaceVlaninBridgeExists": "Couldn’t add some interfaces to LAG. They contain VLANs that are part of a bridge interface.",
  "DuplicatesNotAllowed": "Can't select an outbound interface more than once.",
  "DuplicatesNotAllowedInterface": "Duplicate entries of a outbound interface is not allowed",
  "NoMoreRowsInterface": "Can't add another row. You've selected all the configured outbound interfaces.",
  "NoMoreRows": "You cannot add more rows",
  "ReachedMaxLimitOfMembers": "Maximum allowed members: {maxBridgeMembers}",
  ...
  "WPNetworkSuccess": "Created the wireless network \"{name}\"",
  ...
  "WPNetworkFail": "Couldn't add the wireless network \"{name}\"",
  "WPNetworkUpdateSuccessfully": "Updated the wireless network \"{name}\"",
  "WPNetworkUpdateFail": "Couldn't update the wireless network  \"{name}\"",
  ...
  "NATPolicyAddSuccess": "Added NAT rule \"{name}\"",
  "NATPolicyAddFail": "Couldn't add NAT rule \"{name}\"",
  "NATPolicyUpdateSuccess": "Updated NAT rule \"{name}\"",
  "NATPolicyUpdateFail": "Couldn't update NAT rule \"{name}\"",
  ...
  "FWResetDataSuccess": "Firewall rule's data transfer count has been reset.",
  "FWResetFail": "Couldn't reset the rule's data transfer count.",
  ...
  "PolicyRouteSuccess": "Added SD-WAN policy route \"{name}\".",
  "PolicyRouteFailed": "Couldn't add SD-WAN policy route \"{name}\".",
  "PolicyRouteExists": "Couldn't create the route. SD-WAN policy route with the name \"{name}\" exists.",
  "PolicyRouteDeleteSuccess": "Deleted SD-WAN policy route.",
  "PolicyRouteDeleteFail": "Couldn't delete SD-WAN policy route.",
  "PolicyRouteUpdateSuccess": "Updated SD-WAN policy route \"{name}\".",
  "PolicyRouteUpdateFailed": "Couldn't update SD-WAN policy route \"{name}\".",
  "PolicyRouteMigratedDeleteSuccess": "Deleted the migrated SD-WAN policy route.",
  "PolicyRouteMigratedDeleteFail": "Couldn't delete the migrated SD-WAN policy route.",
  "PolicyRouteMigratedUpdateSuccess": "Updated the migrated SD-WAN policy route \"{name}\".",
  "PolicyRouteMigratedUpdateFailed": "Couldn't update the migrated SD-WAN policy route \"{name}\".",
  "HGPolicyRouteExists": "Couldn't delete host group. SD-WAN policy route exists for the group.",
  "HostPolicyRouteExists": "Couldn't delete host. SD-WAN policy route exists for the host.",
  "AppObjPolicyRouteExists": "Couldn't delete application object. SD-WAN policy route exists.",
  "AppObjPolicyPartiallydeleted":"One or more application object could not be deleted as they are already assigned to SD-WAN policy route",
  "MACPolicyRouteExists": "Couldn't delete MAC host. SD-WAN policy route exists for the host.",
  "FQDNPolicyRouteExists": "Couldn't delete FQDN host. SD-WAN policy route exists for the host.",
  "PolicyRouteUpdateRuleOrderSuccess": "Updated SD-WAN policy route order.",
  "PolicyRouteUpdateRuleOrderFail": "Couldn't update SD-WAN policy route order.",
  ...
  "CSChangeUserConfigurationSuccess": "Changed user configuration.",
  "CSChangeUserConfigurationFail": "Couldn't change user configuration.",
  ...
  "PatternUpdateStartSuccess": "Pattern update started successfully.",
  "CannotConfigureDomainWithAddrTypePort": "The policy cannot be saved. It is not possible to use the same domain(s) in two policies where the listening port is identical. Please use a different listening port or change the domain(s).",
  "CannotConfigureDomainWithHTTPSRedirection": "The policy cannot be saved. It is not possible to have redirection to HTTPS enabled in two policies using the same domain(s). Please disable the redirection to HTTPS or change the domain(s).",
  ...
  "REDMTUNotInRange": "RED MTU is not within the range 576 to 1500",
  ...
  "FWGroupAddSuccess": "Created firewall rule group and added the rules to the group.",
  "FWGroupAddFail": "Firewall group creation failed",
  "FWGroupRecordExists": "Duplicate group. Group with the same name already exists",
  "FWGroupDelSuccess": "Detached the firewall rules from the group.",
  ...
  "RuleAddedSuccess": "Added the firewall rules to the group.",
  ...
  "WFQOResetSuccess": "Web policy quota has been reset.",
  "CentralEnableSuccess": "Applied settings to update firewall services from Sophos Central.",
  "CentralDisableSuccess": "Applied settings to turn off firewall services from Sophos Central.",
  "CentralEnableFailure": "Couldn’t apply settings to turn on firewall services from Sophos Central.",
  "CentralDisableFailure": "Couldn’t apply settings to turn off firewall services from Sophos Central.",
  ...
  "DKIMSigningUpdateSuccess": "Updated DKIM signing.",
  "DKIMSigningUpdateFail": "Couldn't update DKIM signing.",
  "DKIMSigningAddSuccess": "Added DKIM signing.",
  "DKIMSigningAddFail": "Couldn't add DKIM signing.",
  "DKIMSigningDeleteSuccess": "Deleted DKIM signing.",
  "DKIMSigningDeleteFail": "Couldn't delete DKIM signing.",
  "DKIMVerificationUpdateSuccess": "Updated DKIM verification.",
  "DKIMVerificationUpdateFail": "Couldn't delete DKIM verification.",
  "DEDICATED_INTERFACE_UNPLUGGED": "Some dedicated interfaces are unplugged",
  "RAID_DEFECTIVE_HARD_DISK": "Raid degraded. Inserted defective hard disk",
  "RAID_REBUILD_STARTED": "Started RAID rebuild process",
  "IPS_ALERT_CRITICAL": "Critical",
  ...
  "MONITOR_INTERFACE_UNPLUGGED": "Port monitored by HA appliance is unplugged",
  "RAID_HARD_DISK_REPLACEMENT_NEEDED": "RAID degraded. We recommend hard disk replacement.",
  "SNMPUserEditSucessMessage": "Updated SNMP configuration",
  "SNMPUserEditFailedMessage": "Couldn't update SNMP configuration",
  ...
  "AlertUpdateConfiguration": "Update alert configuration?",
  "AdminSettingsconfigError":"Go to Administration > Admin settings > Admin console and end-user interaction and specify a valid hostname or interface IP address.",
  "EncPassword": "Enter encryption password",
  "ConfirmEncPassword": "Confirm encryption password",
  "AuthPassword": "Enter authentication password",
  "ConfirmAuthPassword": "Confirm authentication password",
  "TrapV3IPAlreadyExists": "IP address exists",
  "InvalidPasswordComplexity": "password doesn't conform to the configured complexity",
  "EnableQueryOrTrap": "Turn on Accept queries or Send traps.",
  "UserAlreadyExists": "User exists",
  "FeedbackSuccess": "Submitted feedback",
  "InvalidParams": "Invalid input or missing parameters",
  "AFObjectAddSuccess": "Added application object \"{name}\".",
  "AFObjectAddRuleFail": "Couldn't create application object \"{name}\".",
  "AFObjectDeleteSuccess": "Deleted application object.",
  "AFObjectDeleteFail": "Couldn't delete application object.",
  "AFObjectExists": "Application object with this name exists. Specify a different name.",
  "AFObjectUpdateSuccess": "Updated application object \"{name}\".",
  "AFObjectUpdateFail": "Couldn't update application object \"{name}\".",
  "MinimumCharactersRequired": "{label} must have at least {minlength} characters",
  "MaximumCharactersRequired": "{label} must have a maximum of {maxlength} characters",
  "EnableQuery": "You must turn on Query.",
  "DkimSigningRecordExists": "DKIM signing record with this domain exists.",
  "FQDNHGNatRuleExists": "Can't delete FQDN host group. It's part of a NAT rule.",
  "FQDNNatRuleExists": "Can't delete FQDN host. It's part of a NAT rule.",
  "HGNatRuleExists": "Can't delete host group. It's part of a NAT rule.",
  "HostNatRuleExists": "Can't delete host. It's part of a NAT rule.",
  "MACNatRuleExists": "Can't delete host. It's part of a NAT rule.",
  "ServiceGrpNatRuleExists": "Can't delete service group. It's part of a NAT rule.",
  "ServiceNatRuleExists": "Can't delete service. It's part of a NAT rule.",
  "ServiceRecordExistInNatRule": "Can't change the protocol or number of ports of the service. It's in use in NAT rules.",
  "NATRuleUpdateRecordExist": "NAT rule \"{__newname}\" exists. Specify a different name.",
  "CountryHostNATRuleExist": "Can't delete country host. It's part of a NAT rule.",
  "CountryGrpNATRuleExistsMessage": "Can't delete country group. It's part of a NAT rule.",
  "NATPolicyRecordExists": "NAT rule \"{name}\"  exists. Specify a different name.",
  "ResetNATUsageSuccess":"NAT rule's data transfer count has been reset.",
  "ResetNATUsageFail":"Couldn't reset NAT rule's data transfer count.",
  "UnlinkFWRuleSuccess":"Unlinked the firewall rule",
  "UnlinkFWRulefail":"Couldn't unlink firewall rule",
  "EmptyPasswordField": "Password must have at least 1 character",
  "HotfixUpdateSucc" : "Updated hotfix settings",
  "HotfixUpdateFail" : "Couldn't update hotfix settings",
  "LinkedNATRuleInfo" : "All the matching criteria of firewall, including users and schedule apply to its linked NAT rule. Can’t edit these in the NAT rule.",
  "EditLinkedNATRuleInfo" : "All the matching criteria of firewall {ruleInfo}, including users and schedule apply to its linked NAT rule. Can’t edit these in the NAT rule.",
  "NATIPRangeConflict": "IP ranges of original and translated destinations don’t have the same number of IP addresses. NAT method can’t be one-to-one.",
  "HAInterfaceNotAvailable":"The dedicated HA link interface isn't available for configuring quickHA mode.",
  "HAFailedToConfigDMZ":"Couldn't configure the dedicated HA link port for quickHA mode.",
  "HANetworkCollusion":"Couldn't configure quickHA mode due to network collision.",
  "QuickHAModeinitialize":"Initiated QuickHA mode discovery.",
  "QuickHAModeStopSuccess":"Stopped QuickHA mode discovery.",
  "QuickHAModeStopfail":"Couldn't stop QuickHA mode discovery.",
  "EthernetTypesExists":"Ethernet frame type exists.",
  "EthernetTypesRangeMessage":"Acceptable range of Ethernet frame type values: (600-FFFF)",
  "InvalidEthernetType":"Invalid Ethernet frame type.",
  "EthernetTypesExceedsLimit":"You can specify a maximum of 100 Ethernet frame types.",
  "STPHAConfWarning":"Can't turn on STP when HA is configured.",
  "HASTPConfWarning":"Can't configure HA when you've turned on STP on a bridge interface.",
  "HAPassnotcontsingleanddoublequt": "Passphrase can't have single or double quotes (' \").",
  "EthernetFrameInputLength":"Ethernet frame type can’t have more than 4 characters.",
  "FilterVLANWarningMessage":"VLAN filtering applies to bridged traffic not to routed traffic.",
  "BridgePairNoIPWarningMessage":"When you configure a bridge interface without an IP address, features like NAT rules and web filtering won’t function.",
   "___END___": "___END___"    // This is dummy label. Do not delete this line. This label is not used anywhere.
};
